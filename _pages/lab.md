...
<div class="row align-items-center mb-4">
  <div class="col-sm-3">
    {% include figure.liquid path="assets/img/cheng-profile.jpg" title="Miranda Too" class="img-fluid rounded-circle z-depth-1" style="width: 180px; height: 180px; object-fit: cover;" %}
  </div>
  <div class="col-sm-9">
    <h4>Miranda Too</h4>
    <p><strong>PhD Student, Social-Personality Psychology</strong></p>
    <p>Miranda studies humility, prestige, and reputation.</p>
  </div>
</div>

<div class="row align-items-center mb-4">
  <div class="col-sm-3">
    {% include figure.liquid path="assets/img/cheng-profile.jpg" title="Spencer Arshinoff" class="img-fluid rounded-circle z-depth-1" style="width: 180px; height: 180px; object-fit: cover;" %}
  </div>
  <div class="col-sm-9">
    <h4>Spencer Arshinoff</h4>
    <p><strong>PhD Student, Social-Personality Psychology</strong></p>
    <p>Spencer studies attitudes toward work, cultural change, social values, and temporal analysis.</p>
  </div>
</div>
